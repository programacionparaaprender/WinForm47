...
Public Class Presentacion1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FormularioNuevo.Presentacion1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPresentacion1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Presentacion1 = New Presentacion1()
        rpt.Site = Me.Site
        Return rpt
    End Function
